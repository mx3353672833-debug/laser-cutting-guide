...
|---|---|---|---|
| G1 | Practice machine model/runtime unknown | Cannot hard-code power-on/button paths | field |
| G2 | No live first-part / cut-face photo set | ch. 09 needs self-taken samples | missing media |
| G3 | No vendor official demo guide | ch. 14 is project-authored | field |
| G4 | No universal nozzle lifetime in days | condition criteria only | keep |
| G5 | No public through-cut quantitative standard | symptoms + pending | keep |
...
Open an issue with the learning / errata / version-diff templates.
